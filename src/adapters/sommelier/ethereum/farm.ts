...
export async function getFarmContracts(ctx: BaseContext, addresses: `0x${string}`[]): Promise<Contract[]> {
...
export async function getSommelierFarmBalances(ctx: BalancesContext, pools: Contract[]): Promise<Balance[]> {
