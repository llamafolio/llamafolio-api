...
export async function getLendContracts(ctx: BaseContext, morhoLens: Contract) {
...
export async function getLendBorrowBalances(ctx: BalancesContext, markets: Contract[], morphoLens: Contract) {
...
export async function getUserHealthFactor(ctx: BalancesContext, morphoLens: Contract) {
