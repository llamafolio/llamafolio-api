...
const getContracts = async () => {
  const [poolsMarketsETH, poolsMarketsBSC, poolsMarketsPOLY, poolsMarketsARB, poolsMarketsOPT] = await Promise.all([
...
const getBalances: GetBalancesHandler<typeof getContracts> = async (
  ctx,
  { poolsMarketsETH, poolsMarketsBSC, poolsMarketsPOLY, poolsMarketsARB, poolsMarketsOPT },
) => {
  const [balancesETH, balancesBSC, balancesPOLY, balancesARB, balancesOPT] = await Promise.all([
  ...
  const balances = [...balancesETH, ...balancesBSC, ...balancesPOLY, ...balancesARB, ...balancesOPT]
