...
import { getPoolsBalances, getPoolsContract } from './pool'
...
const getBalances: GetBalancesHandler<typeof getContracts> = async (ctx, { cvxCRVStaker, lockerContract, pools }) => {
