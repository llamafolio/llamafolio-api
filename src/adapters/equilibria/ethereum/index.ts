...
const xEQB: Contract = {
  chain: 'ethereum',
  address: '0xd6eCfD0d5f1Dfd3ad30f267a3a29b3E1bC4fd54f',
  underlyings: ['0xfE80D611c6403f70e5B1b9B722D2B3510B740B2B'],
}
...
export const getContracts = async (ctx: BaseContext) => {
  ...
  return {
    contracts: { pools, locker, ePendle, stkEpendle, xEQB },
    revalidate: 60 * 60,
  }
}
