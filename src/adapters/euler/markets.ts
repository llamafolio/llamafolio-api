...
export async function getPositions(ctx, chain, contracts) {
  ...
  const callsLendRes = await multicall({
    chain: "ethereum",
    calls: callsLend,
    abi: {"inputs":[{"internalType":"address","name":"underlying","type":"address"}],"name":"underlyingToEToken","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},
  });
  ...
  const callsBorrowRes = await multicall({
    chain: "ethereum",
    calls: callsBorrow,
    abi: {"inputs":[{"internalType":"address","name":"underlying","type":"address"}],"name":"underlyingToDToken","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},
  });
