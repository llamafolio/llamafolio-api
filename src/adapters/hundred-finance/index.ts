...
const getContracts = async () => {
  ...
  const [poolsMarketsETH, poolsMarketsFTM, poolsMarketsPOLY, poolsMarketsARB, poolsMarketsOPT] = await Promise.all([
...
const getBalances: GetBalancesHandler<typeof getContracts> = async (
  ctx,
  { poolsMarketsFTM, poolsMarketsETH, poolsMarketsPOLY, poolsMarketsARB, poolsMarketsOPT },
) => {
  const [balancesETH, balancesFTM, balancesPOLY, balancesARB, balancesOPT] = await Promise.all([
  ...
  const balances = [...balancesETH, ...balancesFTM, ...balancesPOLY, ...balancesARB, ...balancesOPT]
