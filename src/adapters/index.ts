...
import arbisFinance from '@adapters/arbis-finance'
import arbitrumExchange from '@adapters/arbitrum-exchange'
import arbswap from '@adapters/arbswap'
...
import hopr from '@adapters/hopr'
import horiza from '@adapters/horiza'
...
import lybraV2 from '@adapters/lybra-v2'
...
import spartadex from '@adapters/spartadex'
